...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      contractor_fee_templates: {
        Row: {
          ...
          fee_type: string
          fixed_payee_name: string | null
          fixed_payer_name: string | null
          id: string
          label: string
          notes: string | null
          payee_role: string
      ...
      cost_budget_lines: {
        ...
        Relationships: [
          {
            foreignKeyName: "cost_budget_lines_claim_id_fkey"
            columns: ["claim_id"]
            isOneToOne: false
            referencedRelation: "claims"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "cost_budget_lines_module_id_fkey"
            columns: ["module_id"]
            isOneToOne: false
      ...
      cost_payments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "cost_payments_project_expense_id_fkey"
            columns: ["project_expense_id"]
            isOneToOne: false
      ...
      project_expenses: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "project_expenses_source_template_id_fkey"
            columns: ["source_template_id"]
            isOneToOne: false
            referencedRelation: "contractor_fee_templates"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      restore_service: { Args: { p_module_id: string }; Returns: Json }
